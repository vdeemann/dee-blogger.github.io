...
body{max-width:48em;margin:2em auto;padding:0 1em;font-family:sans-serif;line-height:1.65;color:#2d3748;background:#fff}a{color:#0066cc;text-decoration:none;border-bottom:1px solid transparent;transition:border-color .2s}a:hover{border-bottom-color:#0066cc}h1{font-size:2.2em;margin:0 0 .4em;color:#1a202c;font-weight:700;line-height:1.2;font-family:sans-serif}h2{font-size:1.6em;margin:2.5em 0 1em;color:#2d3748;font-weight:600;line-height:1.3;border-bottom:2px solid #e2e8f0;padding-bottom:.3em;font-family:sans-serif}h3{font-size:1.3em;margin:2em 0 .8em;color:#4a5568;font-weight:600;line-height:1.3;font-family:sans-serif}p{margin:1.2em 0;font-size:1.05em;line-height:1.7;font-family:sans-serif}small{color:#718096;display:block;margin:0 0 2em;font-size:1em;font-weight:500;font-family:sans-serif}strong{font-weight:600;color:#2d3748}code{background:#f7fafc;color:#e53e3e;padding:.2em .4em;border-radius:4px;font-family:monospace;font-size:.9em;border:1px solid #e2e8f0}pre{background:#f7fafc;padding:.8em 1em;margin:1.5em 0;border-radius:6px;overflow-x:auto;border:1px solid #e2e8f0;box-shadow:0 1px 3px rgba(0,0,0,.1)}pre code{background:0;padding:0;font-size:.9em;color:#2d3748;display:block;border:0;font-family:monospace}ul,ol{margin:1.5em 0;padding-left:2em;font-family:sans-serif}li{margin:.8em 0;line-height:1.6;font-family:sans-serif}nav{margin:2em 0;padding:.8em 0;border-bottom:1px solid #e2e8f0;font-family:sans-serif}blockquote{background:#f7fafc;border-left:4px solid #0066cc;margin:2em 0;padding:1.2em 1.8em;border-radius:0 6px 6px 0;color:#4a5568;font-style:italic;box-shadow:0 1px 3px rgba(0,0,0,.1);font-family:sans-serif}blockquote p{margin:.8em 0;font-family:sans-serif}hr{border:0;height:1px;background:#e2e8f0;margin:2.5em 0}.post-meta{background:#f7fafc;padding:1em 1.2em;border-radius:6px;margin:1.5em 0;border-left:4px solid #0066cc;font-family:sans-serif}.post-meta p{margin:.3em 0;font-size:.95em;color:#4a5568;font-family:sans-serif}
EOF
