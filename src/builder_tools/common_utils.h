...
// For cmark-gfm and brotli
#include <cmark-gfm.h> // <--- THIS MUST BE cmark-gfm.h
...
bool copy_file(const fs::path& source, const std::string& destination);
